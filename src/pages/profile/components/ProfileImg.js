...
export default function ProfileImg({ isLoggedUser, src }) {
    ...
    return (
        ...
        <div>
            ...
            : 
            <img src={src} alt='profile' width={170} height={170} onClick={() => setOpen(true)} style={{cursor: 'pointer'}}/> } 
        ...
        : 
        <Fragment> 
             <img src={src} alt='profile' width={150} height={150} />
        </Fragment>
        }
        </div> 
    )
